          ...
          <IonCardContent >
            ...
            <div className="ion-padding-bottom ion-padding-top">
              { word.meanings && word.meanings.map((meaning, index) => {
                ...
                return (
                  <span key={ index }>
                    <IonBadge className="content">{ meaning.partOfSpeech }</IonBadge>
                    &nbsp;
                  </span>
                );
              })}
            ...
            <IonRow className="ion-padding-top ion-align-items-center ion-justify-content-center ion-text-center">
              ...
              {/* <IonCol size="4">
                <IonCardTitle>
                  <IonIcon icon={ (word.phonetics[0] && word.phonetics[0].audio) ? checkmarkCircleOutline : closeCircleOutline } color="light"/>
                </IonCardTitle>
            ...
            <IonRow>
              <IonCol size="12">
                <IonButton className="card-btn" expand="block" onClick={ openModal }>
